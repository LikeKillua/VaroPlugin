...
public class Broadcaster {
	...
	private void loadMessages() {
		...
		if (!file.exists()) {
			...
			sb.add("&7 Joine doch gerne unseren Discord: https://discord.gg/FjE2HKKWCH ");
	...
	private static String[] getAdMessage() {
		...
		messages[0] = "&7-----------------------------------------";
		messages[1] = "&7Du moechtest uns unterstuetzten dann komm auf unseren dc: https://discord.gg/FjE2HKKWCH";
		messages[2] = "&7-----------------------------------------";
		return messages;
	}
}
